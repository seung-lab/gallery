...
app.factory('LocaleFactory', function() {
  ...
  return locale._ = {
    ...
    outOfSync: 'museum is out of sync. Please make sure you have an active internet connection.',
    ...
    aboutCatalog: 'The catalog contains all the cells that you use or cells that you add to museum.',
